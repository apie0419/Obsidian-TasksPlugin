...
var RelatedTasksRenderChild = class extends import_obsidian6.MarkdownRenderChild {
  ...
  async render() {
    ...
    if (this.showInsertButton) {
      new import_obsidian6.ButtonComponent(header).setButtonText("Insert").setTooltip("Insert this related tasks block into the note").onClick(async () => {
